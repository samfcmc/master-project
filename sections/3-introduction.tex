...
Table [NUMBER HERE] shows some examples of proximity-based
apps and their number of downloads and rating in Google
Play Store and Apple App Store. %TODO: Add table 
...
A trademark, called iBeacon, was created by Apple, to
produce devices, that use BLE, to broadcast a 
...
However, many vendors followed Apple and started producing
their own iBeacons, which are usually called just beacons.
...
Next section \ref{sec:objectives}, we describe the main
